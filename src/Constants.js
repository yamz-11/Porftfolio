...
export const PROJECTS = [
  ...
  },
  {
    ...
    name: "SetakitHama",
    technologyUsed: "Laravel, Mysql",
    description: ["Pest management information website capstone project"],
    url: "",
  },
  {
    image: PROJECT3,
    ...
    technologyUsed: "Laravel, mySql",
    description:
      "Simple todolist has login, register, todo, todo category and member features. Next, for admins and users, admins can CRUD on the todo and todo category pages, delete members and make members admins",
    url: "",
  },
  {
    image: PROJECT11,
  ...
  },
  {
    image: PROJECT2,
    name: "Tikbus",
    technologyUsed: "Java, Firebase",
    description:
      "My final project is to create a bus ticket booking application using Android studio tools. Bus Ticket Booking Application, Consists of features: -Login and Register -Check ticket -availability Book tickets -Check Ticket Prices -Departure Report   ",
    url: "",
  },
  {
    image: PROJECT1,
